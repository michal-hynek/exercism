...
namespace estate_executor {
    ...
    int assemble_code() {
        int zhang_code = zhang::red::code_fragment() + zhang::blue::code_fragment();
        int khan_code = khan::red::code_fragment() + khan::blue::code_fragment();
        int garcia_code = garcia::red::code_fragment() + garcia::blue::code_fragment();

        return zhang_code + khan_code + garcia_code;
    }
}